...
## 
## **Outputs**
## - `results/02_tcells_DE.tsv`
## - `figures/02_tcells_volcano.png` + `.pdf`
## 
## **Cohort**: 91 MS / 46 HC across 3 GSE series — biggest absolute DE hit count
## (~2,670 sig in the original Python run).
## ============================================================
...
s <- load_stratum("cell_tissue_case_control_t_cells")
...
out_fp <- file.path(OUT_DIR, "02_tcells_DE.tsv")
...
ggsave(file.path(FIG_DIR, "02_tcells_volcano.png"), p,
       width = 11, height = 8, dpi = 200)
ggsave(file.path(FIG_DIR, "02_tcells_volcano.pdf"), p, width = 11, height = 8)
print(p)
