...
## 
## **Outputs**
## - `results/03_bcells_DE.tsv`
## - `figures/03_bcells_volcano.png` + `.pdf`
## 
## **Cohort**: 124 MS / 49 HC across 3 GSE series — moderate signal (~354 sig).
## ============================================================
...
s <- load_stratum("cell_tissue_case_control_b_cells")
...
out_fp <- file.path(OUT_DIR, "03_bcells_DE.tsv")
...
ggsave(file.path(FIG_DIR, "03_bcells_volcano.png"), p,
       width = 11, height = 8, dpi = 200)
ggsave(file.path(FIG_DIR, "03_bcells_volcano.pdf"), p, width = 11, height = 8)
print(p)
