...
## 
## R/limma rerun of methylation stratum `label_context_case_control_whole_blood_ocrelizumab` from
...
## 
## **Outputs**
## - `results/03_wb_ocrelizumab_meth_DMP.tsv` (probe level)
## - `results/03_wb_ocrelizumab_meth_gene.tsv` (gene level via Stouffer)
## - `figures/03_wb_ocrelizumab_meth_volcano_probe.png`, `03_wb_ocrelizumab_meth_volcano_gene.png`
## 
## **Ocrelizumab on-treatment context**: 6 MS / 18 HC.
## Python pipeline found 1 sig DMP, DUSP22/NKX6-2 promoter hits.
## ============================================================
...
s <- load_meth_stratum("label_context_case_control_whole_blood_ocrelizumab")
...
write.table(dmp, file.path(OUT_DIR, "03_wb_ocrelizumab_meth_DMP.tsv"),
            sep = "\t", row.names = FALSE, quote = FALSE)
write.table(gene_level, file.path(OUT_DIR, "03_wb_ocrelizumab_meth_gene.tsv"),
            sep = "\t", row.names = FALSE, quote = FALSE)
...
p_probe <- meth_volcano_gg(dmp_lbl,
              ...
              subtitle = sprintf("%d probes · n=%d  %s vs %s",
                                 ...
                                 "MS", "HC"))
ggsave(file.path(FIG_DIR, "03_wb_ocrelizumab_meth_volcano_probe.png"), p_probe,
...
ggsave(file.path(FIG_DIR, "03_wb_ocrelizumab_meth_volcano_gene.png"), p_gene,
       width = 11, height = 8, dpi = 200)
print(p_gene)
